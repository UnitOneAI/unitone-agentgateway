...
Transport Selection:
    MCP_TRANSPORT=streamable python tests/e2e_tool_poisoning_guard_test.py  # Streamable HTTP (default)
    MCP_TRANSPORT=sse python tests/e2e_tool_poisoning_guard_test.py         # SSE transport
"""
