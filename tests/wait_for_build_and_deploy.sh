...
# Usage: ./wait_for_build_and_deploy.sh <run-id> <image-tag> <resource-group> <app-name> <registry>
...
RESOURCE_GROUP="${3:?Error: RESOURCE_GROUP required as third argument}"
APP_NAME="${4:?Error: APP_NAME required as fourth argument}"
REGISTRY="${5:?Error: REGISTRY required as fifth argument}"
